...
class UserController extends BaseController
{
	...
	public function login()
	{
		...
		$scolarite_max = $newScolariteMax->search(['id_s' => $connaissance['id_s_max']]);
		$newCommentaire = new CommentaireModel();
		$commentaite = $newCommentaire->search(['id_et' => $_SESSION['user']['id_u']]);
		$avg = $newCommentaire->avgNoteEtudiant($_SESSION['user']['id_u']);
		$this->show('Detailsetudiant/Detailsetudiant', ['etudiant' => $etudiant[0], 'connaissance' => $connaissance, 'scolarite_min' => $scolarite_min, 'scolarite_max' => $scolarite_max, 'avg' => $avg, 'commentaire' =>$commentaite]);
